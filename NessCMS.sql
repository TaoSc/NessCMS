...
('BXBAzeuqkeC', 'en-us', 1, 'pages', 'index_text', '<p>Hello everyone.<br>Welcome to my website!</p>'),
('BXBAzeuqkeC', 'fr-fr', 1, 'pages', 'index_text', '<p>Bonjour tout le monde.<br>Bienvenue sur mon site !</p>'),
