	...
	<fieldset>
		...
		<div class="col-lg-offset-1 col-lg-10">
			<div class="form-group">
				<label class="col-md-4 control-label" for="anonymous_coms"><?php echo $clauses->get('anonymous_coms'); ?></label>
				<div class="col-md-4">
					<div class="checkbox">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="anonymous_votes"><?php echo $clauses->get('anonymous_votes'); ?></label>
				<div class="col-md-4">
					<div class="checkbox">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="name"><?php echo $clauses->get('site_name'); ?></label>
				<div class="col-md-4">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="private_emails"><?php echo $clauses->get('private_emails'); ?></label>
				<div class="col-md-4">
					<div class="checkbox">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="url_rewriting"><?php echo $clauses->get('url_rewriting'); ?></label>
				<div class="col-md-4">
					<div class="checkbox">
